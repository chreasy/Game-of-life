...
"register"),filter:b("$filterProvider","register"),controller:b("$controllerProvider","register"),directive:b("$compileProvider","directive"),component:b("$compileProvider","component"),config:y,run:function(a){r.push(a);return this}};h&&y(h);return L})}})}function ge(a){O(a,{bootstrap:zc,myCopy:Pa,extend:O,merge:Vd,equals:la,element:C,forEach:n,injector:gb,noop:z,bind:uc,toJson:fb,fromJson:vc,identity:ab,isUndefined:A,isDefined:v,isString:I,isFunction:D,isObject:G,isNumber:U,isElement:Qb,isArray:E,
